...
export const SignInView = () => {
  ...
  const justRegistered = searchParams.get("justRegistered"); // Registered while email verification is temporarily disabled
      ...
      <div className="bg-[#F4F4F0] h-screen w-full lg:col-span-3 overflow-y-auto">
        <Form {...form}>
          ...
          >
            ...
            {/* Registration Success Notice (verification temporarily disabled) */}
            {justRegistered && (
