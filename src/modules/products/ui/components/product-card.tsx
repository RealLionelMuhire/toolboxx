    ...
    return (
      ...
      >
        ...
        <div className="relative w-40 xs:w-48 sm:w-56 md:w-64 lg:w-72 shrink-0 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 z-10 flex flex-col items-end gap-0.5 sm:gap-1 scale-75 origin-top-right">
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        {/* Stock Status Badge & Sponsored Tag - Floating */}
        <div className="absolute top-2 right-2 sm:top-3 sm:right-3 z-10 flex flex-col items-end gap-1 sm:gap-1.5 scale-75 origin-top-right">
          {sponsorshipStatus === "approved" && (
